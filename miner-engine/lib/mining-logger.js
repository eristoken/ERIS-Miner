...
module.exports =  {
  ...
  init( )
  {
    logStorage = new LocalStorage(this.getFTICLocalFolderPath()  );
    logStorage = new LocalStorage(this.getFTICLocalFolderPath()+'/logs');
  ...
  getFTICLocalFolderPath()
  {
    return this.getOSLocalDataFolderPath()  + '/.ftic';
  },
  ...
  logsExist()
  {
    if (!fs.existsSync(this.getFTICLocalFolderPath()) || !fs.existsSync(this.getFTICLocalFolderPath() +'/logs' )  ){
      return false;
    }

    if (!fs.existsSync(this.getFTICLocalFolderPath()+'/logs/stdout' ) ){
      return false;
    }
